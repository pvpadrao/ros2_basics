...
class BatteryNode(Node): 
    ...
    def call_set_led_server(self, led_number, state):
        ...
        future_obj.add_done_callback(partial(self.callback_call_set_led_server, led_number=led_number, state=state))
    
    def callback_call_set_led_server(self, future_obj, led_number, state):
        try:
